namespace Shuttle.Esb.Management.Subscriptions
{
    partial class SubscriptionManagementView
    {
        ...
        private void InitializeComponent()
        {
			...
			this.InboxWorkQueueUri = new Shuttle.Esb.Management.Shell.QueueHierarchyView();
			...
			this.InboxWorkQueueUri.ShowQueueButtonPosition = Shuttle.Esb.Management.Shell.ShowQueueButtonPosition.Left;
			this.InboxWorkQueueUri.Size = new System.Drawing.Size(733, 20);
			this.InboxWorkQueueUri.TabIndex = 3;
			this.InboxWorkQueueUri.QueueSelected += new System.EventHandler<Shuttle.Esb.Management.Shell.QueueSelectedEventArgs>(this.InboxWorkQueueUri_QueueSelected);
			...
			this.MessageTypeColumn.Width = 712;
			// 
			// label4
			// 
